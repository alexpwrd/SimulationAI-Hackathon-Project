...
# MongoDB setup for the simulation database
mongo_uri = os.getenv("MONGO_URI")
mongo_client = pymongo.MongoClient(mongo_uri)
db = mongo_client["simulation"]
collection = db["synthdata_embedding"]
...
vector_store = MongoDBAtlasVectorSearch(mongo_client, db_name="simulation", collection_name="synthdata_embedding", index_name="vector_index", embedding_key="embedding")
